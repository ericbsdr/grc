<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $assetClassificationsAsset->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $assetClassificationsAsset->id)]
            )
        ?></li>
...
<div class="assetClassificationsAssets form large-9 medium-8 columns content">
    ...
    <fieldset>
        <legend><?= __('Edit Asset Classifications Asset') ?></legend>
        <?php
